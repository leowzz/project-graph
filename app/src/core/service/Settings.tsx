    ...
    .default([
      ...
      },
      {
        ...
        children: [
          ...
          { type: "item", id: "setSelectedEdgeSourceConnectLocationUp", icon: "ArrowRightFromLine" },
          { type: "separator", id: "edge-source-connect-location-sep-2" },
          { type: "item", id: "setSelectedEdgeSourceConnectLocationLeft", icon: "ArrowRightFromLine" },
          ...
          { type: "item", id: "setSelectedEdgeSourceConnectLocationDown", icon: "ArrowRightFromLine" },
      ...
      },
      {
        ...
        children: [
          ...
          { type: "item", id: "setSelectedEdgeTargetConnectLocationUp", icon: "ArrowUpToLine" },
          { type: "separator", id: "edge-target-connect-location-sep-2" },
          { type: "item", id: "setSelectedEdgeTargetConnectLocationLeft", icon: "ArrowUpToLine" },
          { type: "item", id: "setSelectedEdgeTargetConnectLocationCenter", icon: "SquareDot" },
          { type: "item", id: "setSelectedEdgeTargetConnectLocationRight", icon: "ArrowUpToLine" },
